...
type PayloadAKeys = typeof payloadA;

export interface IPayloadA extends PayloadAKeys {}

type PayloadBKeys = typeof payloadB;

export interface IPayloadB extends PayloadBKeys {}

type PayloadCKeys = typeof payloadC;

export interface IPayloadC extends PayloadCKeys {}
